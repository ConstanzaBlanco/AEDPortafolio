...
public class PricipalTransformarTexto {
    public static void main(String[] args) {
        PricipalTransformarTexto pr = new PricipalTransformarTexto();
        pr.transformarTextoT9("src/main/java/UT1_PD6_Ej3P1/entrada.txt");
    ...
    public static void transformarTextoT9(String rutaArchivo){
        ...
        escribirArchivo("salida.txt", letrasEnT9.toArray(new String[0]));
    }
