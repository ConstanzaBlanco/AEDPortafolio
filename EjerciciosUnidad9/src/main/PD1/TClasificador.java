...
public class TClasificador {
    ...
    private void quicksort(int[] entrada, int i, int j) {
        ...
        int posicionPivote = encuentraPivote2Prim(izquierda, derecha, entrada);
        if (posicionPivote >= 0) {
    ...
    public int encuentraPivoteElemCentral(int izq, int der, int[] entrada){
        return (izq+der)/2;
    }

    public int encuentraPivote2Prim(int izq, int der, int[] entrada){
    ...
    public int encuentraPivoteMedia(int izq, int der, int[] entrada) {
    ...
    public void intercambiar(int[] vector, int pos1, int pos2) {
    ...
    public static int METODO_CLASIFICACION= METODO_CLASIFICACION_QUICKSORT
            ;
