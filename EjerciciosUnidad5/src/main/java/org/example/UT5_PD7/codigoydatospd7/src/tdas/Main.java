...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        String[] lineasAbonados = ManejadorArchivosGenerico.leerArchivo("src/main/java/org/example/UT5_PD7/codigoydatospd7/src/abonados.txt");
        ...
        String[] lineasCodigos = ManejadorArchivosGenerico.leerArchivo("src/main/java/org/example/UT5_PD7/codigoydatospd7/src/codigos1.txt");
        String codigoPais = "";
        String codigoArea = "";
        ...
        ManejadorArchivosGenerico.escribirArchivo("src/main/java/org/example/UT5_PD7/codigoydatospd7/src/salida.txt", salida.toArray(new String[0]));
    }
}
